      ...
      <div class="row">
        <div class="col">
          <NewListCard
            ...
            title="融资途径"
            :data="data"
            more="/finance/advi/second/menu?title=融资途径"
          ></NewListCard>
          <Tabs
            :TabsList="[{title:'融资案例',url:'/finance/advi/second/menu?title=融资案例'}]"
            :newsList="newsList"
          ></Tabs>
        </div>
        <div class="col">
          <NewListCard
            ...
            :data="data"
            title="警惕诈骗"
            more="/finance/advi/second/menu?title=警惕诈骗"
          ></NewListCard>
          <NewListCard
            icon="icon-scjg"
            :data="data"
            title="融资方式"
            more="/finance/advi/second/menu?title=融资方式"
          ></NewListCard>
        </div>
      </div>
    </div>
