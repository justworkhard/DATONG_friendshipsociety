...
export default {
  ...
  data() {
    return {
      ...
      activeTitle: "",
      menuList: [
        { title: "政经信息", url: "/menu/list/active" },
        { title: "创业创新服务平台介绍", url: "/menu/list/introduce" },
        { title: "新闻动态", url: "/menu/list/compony" },
        { title: "创业分享", url: "/menu/list/compony" },
        { title: "资本市场", url: "/menu/list/compony" }
      ]
    };
  },
  methods: {
